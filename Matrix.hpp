...
namespace zich
{
    ...
    public:
        ...
        Matrix operator++(int num) const;                           /* create a copy of the matrix, add to the matrix and return the copy */
        ...
        Matrix operator--(int num) const;                           /* create a copy of the matrix, remove from the matrix and return the copy */
